...
export default function Navbar(props: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 px-6 py-8 mt-2 sm:mt-8 sm:px-14 md:px-20">
      <div className="flex items-center justify-between mx-auto lg:max-w-7xl">
        <nav className="items-center hidden gap-2 px-2 py-2 rounded-full shadow-md ring-1 ring-zinc-200 backdrop-blur-md dark:ring-accent/50 md:flex">
                  ...
                  >
                    {_link.href === pathName && (
                      <motion.span
                        ...
                        className="absolute inset-0 rounded-full -z-10 bg-accent group-hover:bg-accent/80"
                      ></motion.span>
                    )}
                    {_link.title}
                  </Link>
